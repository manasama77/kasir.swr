...
--
-- Host: localhost:3306
-- Generation Time: Apr 21, 2022 at 05:08 AM
...
(782, 1, 3, '8993200664399', 'KANZLER Crispy Chciken Nugget 450 gr', '8993200664399', 1, 0, '', '', 55, '', 1, '2022-04-20 11:32:50', NULL, NULL),
...
(2, 11, 574, 1, '2022-03-31 17:47:07', 6, 4, 25380.00, 'stock_in', NULL, '1'),
...
(94, 11, 213, 1, '2022-04-01 23:29:33', 6, 5, 46900.00, 'stock_in', NULL, '1'),
...
(101, 11, 227, 1, '2022-04-01 23:29:33', 6, 3, 18090.00, 'stock_in', NULL, '1'),
...
(105, 11, 555, 1, '2022-04-01 23:32:24', 5, 9, 13500.00, 'stock_in', NULL, '1'),
...
(123, 11, 697, 1, '2022-04-01 23:59:37', 12, 13, 14050.00, 'stock_in', NULL, '1'),
(124, 11, 691, 1, '2022-04-01 23:59:37', 10, 11, 16600.00, 'stock_in', NULL, '1'),
...
(287, 11, 716, 1, '2022-04-07 19:12:53', 3, 1, 24000.00, 'stock_in', NULL, '3'),
...
(292, 11, 719, 1, '2022-04-07 19:35:46', 5, 7, 59000.00, 'stock_in', NULL, '3'),
...
(340, 11, 747, 1, '2022-04-09 08:31:16', 3, 4, 0.00, 'stock_in', NULL, '4'),
...
(361, 11, 744, 1, '2022-04-10 08:58:18', 6, 8, 15100.00, 'stock_in', NULL, '1'),
...
(434, 11, 295, 1, '2022-04-14 14:42:29', 6, 3, 13500.00, 'stock_in', NULL, '4'),
...
(441, 11, 751, 1, '2022-04-14 15:05:45', 5, 9, 0.00, 'stock_in', NULL, '4'),
...
(525, 11, 135, 1, '2022-04-20 11:41:15', 5, 4, 16900.00, 'stock_in', NULL, '6'),
(526, 11, 697, 1, '2022-04-20 11:41:15', 5, 6, 14050.00, 'stock_in', NULL, '6'),
(527, 11, 770, 1, '2022-04-20 11:41:15', 3, 4, 14000.00, 'stock_in', NULL, '6'),
(528, 11, 701, 1, '2022-04-20 11:41:15', 5, 5, 16700.00, 'stock_in', NULL, '6'),
(529, 11, 725, 1, '2022-04-20 11:41:15', 3, 5, 14900.00, 'stock_in', NULL, '6'),
(530, 11, 614, 1, '2022-04-20 11:41:15', 3, 4, 41000.00, 'stock_in', NULL, '6'),
(531, 11, 780, 1, '2022-04-20 11:41:15', 2, 4, 0.00, 'stock_in', NULL, '6'),
(532, 11, 563, 1, '2022-04-20 11:41:15', 2, 4, 19400.00, 'stock_in', NULL, '6'),
(533, 11, 781, 1, '2022-04-20 11:41:15', 4, 8, 0.00, 'stock_in', NULL, '6'),
(534, 11, 783, 1, '2022-04-20 11:41:15', 5, 10, 0.00, 'stock_in', NULL, '6'),
(535, 11, 691, 1, '2022-04-20 11:41:15', 3, 4, 16600.00, 'stock_in', NULL, '6'),
(536, 11, 779, 1, '2022-04-20 11:41:15', 3, 6, 0.00, 'stock_in', NULL, '6'),
(537, 11, 777, 1, '2022-04-20 11:41:15', 3, 6, 0.00, 'stock_in', NULL, '6'),
(538, 11, 775, 1, '2022-04-20 11:41:15', 3, 6, 0.00, 'stock_in', NULL, '6'),
(539, 11, 776, 1, '2022-04-20 11:41:15', 3, 6, 0.00, 'stock_in', NULL, '6'),
(540, 11, 782, 1, '2022-04-20 11:41:15', 20, 40, 0.00, 'stock_in', NULL, '6'),
...
--
ALTER TABLE `tblitem`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=784;
...
--
ALTER TABLE `tblitem_price`
  MODIFY `item_price_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1302;
...
--
ALTER TABLE `tblitem_stock`
  MODIFY `item_stock_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=774;
...
--
ALTER TABLE `tblsales`
  MODIFY `sales_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `tblsales_det`
--
ALTER TABLE `tblsales_det`
  MODIFY `sales_det_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
...
--
ALTER TABLE `tblstock_flow`
  MODIFY `stock_flow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=547;

--
-- AUTO_INCREMENT for table `tblstock_in`
--
ALTER TABLE `tblstock_in`
  MODIFY `stock_in_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;

--
-- AUTO_INCREMENT for table `tblstock_in_det`
--
ALTER TABLE `tblstock_in_det`
  MODIFY `stock_in_det_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=246;

--
-- AUTO_INCREMENT for table `tblstock_out`
--
ALTER TABLE `tblstock_out`
  MODIFY `stock_out_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `tblstock_out_det`
--
ALTER TABLE `tblstock_out_det`
  MODIFY `stock_out_det_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
